...
- 字体大小改变（font size change）

- 窗口大小改变（screen change）

- 样式表添加或者删除（add/delete stylesheets）

- JS 更改 DOM 元素（更改 DOM 颜色除外）
...
![img](D:\chenyh\ienyh\resourses\575261407_1581644656315_0ABBCEA6A0A2F0AE328C3B326FAC8A13.png)
